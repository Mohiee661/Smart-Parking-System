...
# -------------------------------------------------
def reserve_slot(slot_id, duration_minutes):
    """
    ...
    try:
        cur.execute("""
            ...
            (slot_id, start_time, end_time, price_per_hour, total_cost)
            VALUES (?, ?, ?, ?, ?)
        """, (
            slot_id,
            now,
...
def get_active_reservations():
    ...
    cur.execute("""
        SELECT slot_id, start_time, end_time, total_cost
        FROM reservations
    """)
    ...
    for slot_id, start, end, cost in rows:
